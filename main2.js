		...
		<div class="card question-card">
			<div class="card-body">
				...
				<ul class="list-group list-group-flush">
					...
					${
            parsedData[index][8]
              ? `<li class="list-group-item">E) ${parsedData[index][6]}</li>`
              : ""
          }
					${
            parsedData[index][9]
              ? `<li class="list-group-item">F) ${parsedData[index][7]}</li>`
              : ""
          }
				</ul>
				<div class="d-flex align-items-center mt-2">
					<button class="btn btn-custom mt-3" onclick="toggleAnswer(this, '${
            parsedData[index][9]
              ? parsedData[index][8]
              : parsedData[index][8]
              ? parsedData[index][7]
              : parsedData[index][6]
				...
				<div class="d-flex align-items-center mt-2">
					<button class="btn btn-custom mt-3" onclick="toggleExplanation(this, '${
            parsedData[index][9]
              ? parsedData[index][9]
              : parsedData[index][8]
              ? parsedData[index][8]
